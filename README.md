...
| 장 | 내용 |
|---|---|
| 01~04 | NPU 개념, GPU 비교, 메모리 계층과 데이터 재사용, RBLN SDK 환경 셋업 |
| 05~08 | 모델 올리기·컴파일·최적화, 비전/NLP/생명과학 모델 구동 |
| 09~11 | vLLM 이해, NPU에 LLM 서빙, 서빙 문제점 개선 |
| 12~14 | 벤치마크 모음, 트러블슈팅, 용어집 |
...
2. 용어 표기는 [용어집](pages/14-glossary.md) 기준으로 통일합니다.
