...
| 장 | 내용 |
|---|---|
| 01~02 | NPU 개념, RBLN SDK 환경 셋업 |
| 03~06 | 모델 최적화 원리, 컴파일·최적화, 비전/NLP/생명과학 모델 구동 |
| 07~09 | vLLM 이해, NPU에 LLM 서빙, 서빙 문제점 개선 |
| 10~12 | 벤치마크 모음, 트러블슈팅, 용어집 |
...
2. 용어 표기는 [용어집](pages/12-glossary.md) 기준으로 통일합니다.
