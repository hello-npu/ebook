...
구체적인 메모리 계층과 데이터 흐름은 [3장 NPU 메모리 계층과 데이터 재사용](03-memory-hierarchy.md)에서 자세히 다룹니다.
...
다음 장인 [GPU vs NPU — 무엇이 다른가](02-gpu-vs-npu.md)에서는 GPU의 유연한
병렬 처리 방식과 NPU의 특화된 실행·데이터 흐름이 실제 AI 워크로드에서 만드는
차이를 비교합니다.
